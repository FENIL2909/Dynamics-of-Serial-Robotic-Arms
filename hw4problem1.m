...
Ixx1 = (m1*((w*w) + (L1*L1)))/12;
Iyy1 = (m1*((l*l) + (L1*L1)))/12;
Izz1 = (m1*((l*l) + (w*w)))/12;

Ixx2 = (m2*((w*w) + (L2*L2)))/12;
Iyy2 = (m2*((l*l) + (L2*L2)))/12;
Izz2 = (m2*((l*l) + (w*w)))/12;

Ixx3 = (m3*((w*w) + (L3*L3)))/12;
Iyy3 = (m3*((l*l) + (L3*L3)))/12;
Izz3 = (m3*((l*l) + (w*w)))/12;

if addrotationalinertia

    I1 = [Ixx1 0 0; 0 Iyy1 0; 0 0 Izz1]; %O3;
    I2 = [Ixx2 0 0; 0 Iyy2 0; 0 0 Izz2]; %O3;
    I3 = [Ixx3 0 0; 0 Iyy3 0; 0 0 Izz3]; %O3;
else
    I1 = O3;
    I2 = O3;
    I3 = O3;
...
G2 = [I2,O3;O3,(m3*I)];% ...; Spatial Inertia Matrix for link 2
